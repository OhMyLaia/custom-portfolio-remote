  ...
  en: [
    {
      ...
      tags: ['Next.js', 'TypeScript', 'Node.js', 'Express', 'MongoDB', 'Tailwind', 'Vercel', 'Railway', 'GitHub Actions', 'Playwright', 'Jest', 'Capacitor', 'Firebase']
    },
    {
      dateRange: '2025',
      ...
      tags: ['Vue', 'JavaScript', 'Pinia', 'Tailwind', 'REST API', 'Playwright']
    },
    {
      dateRange: '2025',
      ...
      tags: ['React', 'TypeScript', 'Zod', 'Tailwind', 'API', 'Vitest']
    }
  ],
  es: [
    {
